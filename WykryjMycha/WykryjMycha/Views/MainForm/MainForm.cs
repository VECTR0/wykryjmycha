namespace WykryjMycha
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            _settingsController.Initialize(numMetricDistanceWeight, numMetricAngleWeight, maxMergeDistance, minDistance, angleLimitDegree, angleRefPointMinDist, numDrawingTimeout, numMetricAngleWeight, numMetricDistanceWeight, numMaxItertions, numPopulationSize, numSelectedSize, numMutationProbability, numTargetQuality);
